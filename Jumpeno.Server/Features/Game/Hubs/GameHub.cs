...
public class GameHub : Hub {
    ...
    private GameContext? GameContext {
        get { try { return (GameContext) Context.Items[GameContext.ID]!; } catch { return null; } }
        set { Context.Items[GameContext.ID] = value; }
    }
    private TaskCompletionSource? ConnectTCS {
        get { try { return (TaskCompletionSource) Context.Items[GameContext.TCS_ID]!; } catch { return null; } }
        set { Context.Items[GameContext.TCS_ID] = value; }
    }
