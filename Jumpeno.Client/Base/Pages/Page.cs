...
public class Page : ComponentBase, IAsyncDisposable {
    ...
    // Static methods ---------------------------------------------------------------------------------------------------------------------
    public static Page Current => RequestStorage.Get<Page>(REQUEST_STORAGE_KEYS.CURRENT_PAGE) ?? new Error404Page();
    private static void SetCurrent(Page page) => RequestStorage.Set(REQUEST_STORAGE_KEYS.CURRENT_PAGE, page);
