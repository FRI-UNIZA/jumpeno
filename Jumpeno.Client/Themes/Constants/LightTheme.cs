...
public class LightTheme: BaseTheme {
    ...
    // Secondary surface ------------------------------------------------------------------------------------------------------------------
    public override string COLOR_SECONDARY { get; } = "42, 33, 56";
    public override string COLOR_SECONDARY_HIGHLIGHT { get; } = "122, 113, 136";
    public override string COLOR_SECONDARY_ACCENT { get; } = "235, 195, 0";
    public override string COLOR_SECONDARY_ACCENT_HIGHLIGHT { get; } = "235, 219, 0";
    public override string COLOR_SECONDARY_SURFACE { get; } = "255, 255, 255";
    public override string COLOR_SECONDARY_SURFACE_HIGHLIGHT { get; } = "235, 235, 235";
    public override string COLOR_SECONDARY_SHADE { get; } = "220, 220, 220";
    public override string COLOR_SECONDARY_SHADE_INVERT { get; } = "60, 60, 60";
    public override string COLOR_SECONDARY_SHADE_STRONG { get; } = "190, 190, 190";
    public override string COLOR_SECONDARY_SHADE_STRONG_INVERT { get; } = "90, 90, 90";
    // Floating surface -------------------------------------------------------------------------------------------------------------------
        // Colors -------------------------------------------------------------------------------------------------------------------------
