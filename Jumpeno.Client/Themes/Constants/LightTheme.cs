...
public class LightTheme : BaseTheme {
    ...
    // Success surface --------------------------------------------------------------------------------------------------------------------
    public override RGBColor COLOR_SUCCESS { get; } = new(68, 221, 36);
    // Primary surface --------------------------------------------------------------------------------------------------------------------
    ...
    // Secondary surface ------------------------------------------------------------------------------------------------------------------
    public override RGBColor COLOR_SECONDARY { get; } = new(42, 33, 56);
    public override RGBColor COLOR_SECONDARY_HIGHLIGHT { get; } = new(122, 113, 136);
    public override RGBColor COLOR_SECONDARY_ACCENT { get; } = new(235, 195, 0);
    public override RGBColor COLOR_SECONDARY_ACCENT_HIGHLIGHT { get; } = new(235, 219, 0);
    public override RGBColor COLOR_SECONDARY_SURFACE { get; } = new(255, 255, 255);
    public override RGBColor COLOR_SECONDARY_SURFACE_HIGHLIGHT { get; } = new(235, 235, 235);
    public override RGBColor COLOR_SECONDARY_BOX { get; } = new(245, 245, 245);
    public override RGBColor COLOR_SECONDARY_SHADE { get; } = new(220, 220, 220);
    public override RGBColor COLOR_SECONDARY_SHADE_INVERT { get; } = new(60, 60, 60);
    public override RGBColor COLOR_SECONDARY_SHADE_STRONG { get; } = new(190, 190, 190);
    public override RGBColor COLOR_SECONDARY_SHADE_STRONG_INVERT { get; } = new(90, 90, 90);
    // Floating surface -------------------------------------------------------------------------------------------------------------------
        // Colors -------------------------------------------------------------------------------------------------------------------------
        ...
        public override string BOX_SHADOW_FLOATING_LEVEL_2 { get; } = "0 0 30px 0 rgba(var(--color-base), 0.3)";
    // Selection surface ------------------------------------------------------------------------------------------------------------------
