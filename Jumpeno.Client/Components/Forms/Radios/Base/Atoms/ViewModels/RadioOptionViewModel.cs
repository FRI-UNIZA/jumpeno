...
public class RadioOptionViewModel<T>(RadioOptionViewModelParams<T> p) : FormViewModel(onError: p.OnError) {
    // Values -----------------------------------------------------------------------------------------------------------------------------
    public int Key { get => DTO.Key; set => DTO.Key = value; }
    public T Value { get => DTO.Value; private set => DTO.Value = value; }
    public string Label { get => DTO.Label; private set => DTO.Label = value; }
