...
public partial class Notification : IDisposable {
    ...
    private Task PersistData() {
        ApplicationState.PersistAsJson(nameof(Notification), new { ServerNotifications = GetServerNotifications() });
    ...
    protected sealed override void OnInitialized() {
        ...
        if (ApplicationState.TryTakeFromJson<NotificationState>(nameof(Notification), out var restored)) {
