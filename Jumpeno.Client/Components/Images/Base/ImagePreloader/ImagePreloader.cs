...
public partial class ImagePreloader {
    ...
    static ImagePreloader() {
        ...
        Add(IMAGE.TILE);
        Add(IMAGE.TILE_MAGIC_TEMPLE_ACTIVE);
        Add(IMAGE.TILE_MAGIC_TEMPLE_BACKGROUND);
        Add(IMAGE.TILE_EMERALD_GROVE_ACTIVE);
        Add(IMAGE.TILE_EMERALD_GROVE_BACKGROUND);
        Add(IMAGE.TILE_AMETHYST_DAWN_ACTIVE);
        Add(IMAGE.TILE_AMETHYST_DAWN_BACKGROUND);
