...
public class Map : IRectFQuadStorable, IRenderable<Game> {
    // World ------------------------------------------------------------------------------------------------------------------------------
    ...
    public Map(float minX, float maxX, float minY, float maxY, List<Tile> tiles, string background, string foreground)
    : this(minX, maxX, minY, maxY, 0, 0, 0, 0, tiles, background, foreground) {}
