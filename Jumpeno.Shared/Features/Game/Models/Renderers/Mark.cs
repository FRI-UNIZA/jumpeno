...
public static class Mark {
    ...
    // Rendering --------------------------------------------------------------------------------------------------------------------------
    public static async Task RenderMark(Canvas2DContext ctx, (Game Game, Player Player) @params) {
        // 1) Parameters:
    ...
    public static async Task RenderName(Canvas2DContext ctx, (Game Game, Player Player, string Font) @params) {
        // 1) Parameters:
