...
public class Animation : IRenderable<(Game Game, SKIN Skin, Body Body)> {
    ...
    // Attributes -------------------------------------------------------------------------------------------------------------------------
    private PointF _Direction; public PointF Direction { get { return _Direction; } private set { _Direction = value; } }
    ...
    // Rendering --------------------------------------------------------------------------------------------------------------------------
    public async Task Render(Canvas2DContext ctx, (Game Game, SKIN Skin, Body Body) @params) {
