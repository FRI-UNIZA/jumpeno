...
public static class Collision {
    ...
    // Resolves collision of position with boundary box (ensures that position stays inside):
    public static bool Resolve(
    ...
    // Resolves collision of before and after frame position with the list of given items:
